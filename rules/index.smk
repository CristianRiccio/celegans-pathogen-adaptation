...
# # SLURM
# # snakemake --jobs 2000 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/HS678/alignment/target/celegans/ref/wormbase/release270/query/n2/{adults,embryos}/{BIGb446,BIGb468,hb101}/repl{1,2,3}/hisat2/alnSortedByCoord.bam.bai output/HS755/alignment/target/celegans/ref/wormbase/release270/query/nob27/embryos/hb101/repl{1,2,3}/hisat2/alnSortedByCoord.bam.bai output/HS755/alignment/target/celegans/ref/wormbase/release270/query/n2/embryos/{hb101,pa14,plum}/repl{1,2,3}/hisat2/alnSortedByCoord.bam.bai --cluster-config slurm.json --cluster "sbatch -A {cluster.A} -p {cluster.p} -t {cluster.time} --output {cluster.output} --error {cluster.error} --ntasks {cluster.ntasks} --cpus-per-task {cluster.cpus} --mem {cluster.mem} --mail-type {cluster.mailType} --mail-user {cluster.mailUser}" -n
...
# snakemake --cores 7 --use-conda --printshellcmds --keep-going --reason output/HS755/alignment/target/celegans/ref/ensembl/release96/query/n2/embryos/{hb101,pa14,plum}/repl{1,2,3}/hisat2/alnSortedByCoord.bam.bai -n
# SLURM
# snakemake --jobs 200 --use-conda --resources downloads=1 --printshellcmds --keep-going output/alignment/target/celegans/ref/ensembl/release95/query/{adults,embryos}/{BIGb446,BIGb468,hb101}/repl{1,2,3}/hisat2/alnSortedByCoord.bam.bai --cluster-config slurm.json --cluster "sbatch -A {cluster.A} -p {cluster.p} -t {cluster.time} --job-name {cluster.jobName} --output {cluster.output} --error {cluster.error} --ntasks {cluster.ntasks} --cpus-per-task {cluster.cpus} --mem {cluster.mem} --mail-type {cluster.mailType} --mail-user {cluster.mailUser}" -n
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/genome/celegans/ref/wormbase/release269/index/hisat2/index.{1,2,3,4,5,6,7,8}.ht2 -n
...
# snakemake --cores 2 --resources downloads=1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/ensembl/release95/index/hisat2/index.{1,2,3,4,5,6,7,8}.ht2
...
# snakemake --jobs 200 --resources downloads=1 --restart-times 1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/ensembl/release95/index/star/withGTF/Genome --cluster-config slurm.json --cluster "sbatch -A {cluster.A} -p {cluster.p} -t {cluster.time} --output {cluster.output} --error {cluster.error} --ntasks {cluster.ntasks} --cpus-per-task {cluster.cpus} --mem {cluster.mem} --mail-type {cluster.mailType} --mail-user {cluster.mailUser}"
...
# snakemake --cores 1 --resources downloads=1 --restart-times 1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release269/index/Genome
# snakemake --jobs 200 --resources downloads=1 --restart-times 1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release269/index/withoutGFF3/Genome
...
# snakemake --cores 1 --resources downloads=1 --restart-times 1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release269/index/star/withGFF3/Genome
# snakemake --jobs 200 --resources downloads=1 --restart-times 1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release269/index/withGFF3/Genome
...
# local
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/transcriptome/celegans/ref/ensembl/release{94,95,96}/index/kallisto/transcriptome.idx output/transcriptome/celegans/ref/wormbase/release{268..270}/index/kallisto/transcriptome.idx -n
