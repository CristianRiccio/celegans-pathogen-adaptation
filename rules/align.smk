...
# local
# snakemake --cores 8 --printshellcmds --resources downloads=1 --use-conda --keep-going --reason output/HS755/alignment/target/celegans/ref/wormbase/release270/query/nob27/embryos/hb101/repl{1,2,3}/hisat2/aln.sam output/HS755/alignment/target/celegans/ref/wormbase/release270/query/n2/embryos/{hb101,pa14,plum}/repl{1,2,3}/hisat2/aln.sam -n
# SLURM
# snakemake --cores 8 --printshellcmds --resources downloads=1 --use-conda --keep-going --reason output/HS678/alignment/target/celegans/ref/wormbase/release270/query/n2/{adults,embryos}/{BIGb446,BIGb468,hb101}/repl{1,2,3}/hisat2/aln.sam output/HS755/alignment/target/celegans/ref/wormbase/release270/query/nob27/embryos/hb101/repl{1,2,3}/hisat2/aln.sam output/HS755/alignment/target/celegans/ref/wormbase/release270/query/n2/embryos/{hb101,pa14,plum}/repl{1,2,3}/hisat2/aln.sam --cluster-config slurm.json --cluster "sbatch -A {cluster.A} -p {cluster.p} -t {cluster.time} --output {cluster.output} --error {cluster.error} --ntasks {cluster.ntasks} --cpus-per-task {cluster.cpus} --mem {cluster.mem} --mail-type {cluster.mailType} --mail-user {cluster.mailUser}" -n

# snakemake --cores 8 --printshellcmds --resources downloads=1 --use-conda --keep-going output/alignment/target/celegans/ref/ensembl/release95/query/{adults,embryos}/{BIGb446,BIGb468,hb101}/repl{1,2,3}/hisat2/aln.sam
# snakemake --jobs 200 --printshellcmds --resources downloads=1 --use-conda --keep-going output/alignment/target/celegans/ref/ensembl/release95/query/{adults,embryos}/{BIGb446,BIGb468,hb101}/repl{1,2,3}/hisat2/aln.sam --cluster-config slurm.json --cluster "sbatch -A {cluster.A} -p {cluster.p} -t {cluster.time} --output {cluster.output} --error {cluster.error} --ntasks {cluster.ntasks} --cpus-per-task {cluster.cpus} --mem {cluster.mem} --mail-type {cluster.mailType} --mail-user {cluster.mailUser}" -n
...
# snakemake --cores 8 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/HS755/alignment/target/celegans/ref/ensembl/release96/query/n2/embryos/{hb101,pa14,plum}/repl{1,2,3}/hisat2/aln.sam
# SLURM
# snakemake --jobs 2000 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/HS678/alignment/target/celegans/ref/ensembl/release{95,96}/query/n2/{adults,embryos}/{hb101,BIGb446,BIGb468}/repl{1,2,3}/hisat2/aln.sam output/HS755/alignment/target/celegans/ref/ensembl/release96/query/n2/embryos/{hb101,pa14,plum}/repl{1,2,3}/hisat2/aln.sam output/HS755/alignment/target/celegans/ref/ensembl/release96/query/nob27/embryos/hb101/repl{1,2,3}/hisat2/aln.sam --cluster-config slurm.json --cluster "sbatch -A {cluster.A} -p {cluster.p} -t {cluster.time} --job-name {cluster.jobName} --output {cluster.output} --error {cluster.error} --ntasks {cluster.ntasks} --cpus-per-task {cluster.cpus} --mail-type {cluster.mailType} --mail-user {cluster.mailUser}" -n
...
# snakemake --cores 7 --printshellcmds --resources downloads=1 --use-conda --keep-going output/alignment/ensembl/release96/adults/hb101/repl1/Aligned.sortedByCoord.out.bam -n
...
# snakemake --jobs 200 --printshellcmds --use-conda --keep-going output/alignment/target/celegans/ref/wormbase/release269/query/{adults,embryos}/{BIGb446,BIGb468,hb101}/repl{1,2,3}/Aligned.sortedByCoord.out.bam --cluster-config slurm.json --cluster "sbatch -A {cluster.A} -p {cluster.p} -t {cluster.time} --output {cluster.output} --error {cluster.error} --ntasks {cluster.ntasks} --cpus-per-task {cluster.cpus} --mem {cluster.mem} --mail-type {cluster.mailType} --mail-user {cluster.mailUser}"
