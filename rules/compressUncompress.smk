localrules: uncompressCelegansGenomeEnsembl, uncompressCelegansGFF3Ensembl, uncompressCelegansGTFensembl, uncompressCelegansGenomeWormbase, uncompressGFF3wormbase, uncompressGFF2, uncompressGTF, compressFastaPacbio
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/genome/celegans/ref/ensembl/release{90..96}/seq/genome.fa -n
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/transcriptome/celegans/ref/ensembl/release{94,95,96}/seq/transcriptome.fa -n
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/transcriptome/celegans/ref/wormbase/release{269,270}/seq/transcriptome.fa -n
...
rule uncompressCelegansGTFensembl:
    ...
    shell:
        'gzip {input.compressed} --stdout --decompress --force > {output.uncompressed}'
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going ooutput/genome/celegans/ref/ensembl/release{94,95}/annotation/gtf/Caenorhabditis_elegans.WBcel235.gtf
...
rule uncompressCelegansGFF3Ensembl:
    ...
    shell:
        'gzip {input.compressed} --stdout --decompress --force > {output.uncompressed}'
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds output/genome/celegans/ref/ensembl/release{92,93,94,95}/annotation/gff3/Caenorhabditis_elegans.WBcel235.gff3
...
rule uncompressCelegansGenomeWormbase:
    ...
    shell:
        'gzip {input.compressed} --stdout --decompress --force > {output.uncompressed}'
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release{260,261,262,263,264,265,266,267,268,269,270}/seq/c_elegans.PRJNA13758.genomic.fa -n
...
rule uncompressGFF3wormbase:
    ...
    shell:
        'gzip {input.compressed} --stdout --decompress --force > {output.uncompressed}'
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release{260,269,270}/annotation/gff3/c_elegans.PRJNA13758.annotations.gff3 -n
...
rule uncompressGTF:
    ...
    shell:
        'gzip {input.compressed} --stdout --decompress --force > {output.uncompressed}'
# snakemake output/genome/ensembl/release95/annotation/Caenorhabditis_elegans.WBcel235.gtf
...
rule compressFastaPacbio:
    ...
    shell:
        'gzip {input.fasta}'
# snakemake --jobs 200 output/reads/dna/pacbio/all/a.subreads.fa.gz --cluster-config cluster.json --cluster "bsub -n {cluster.nCPUs} -R {cluster.resources} -c {cluster.tCPU} -G {cluster.Group} -q {cluster.queue} -o {cluster.output} -e {cluster.error} -M {cluster.memory}"
