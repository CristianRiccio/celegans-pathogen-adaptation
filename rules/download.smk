...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/genome/celegans/ref/ensembl/release{90..96}/seq/genome.fa.gz -n
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/transcriptome/celegans/ref/ensembl/release{94,95,96}/seq/transcriptome.fa.gz -n
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/ensembl/release{94,95,96}/annotation/gtf/Caenorhabditis_elegans.WBcel235.gtf.gz -n
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds output/genome/celegans/ref/ensembl/release{92,93,94,95}/annotation/gff3/Caenorhabditis_elegans.WBcel235.gff3.gz
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release{260,261,262,263,264,265,266,267,268,269,270}/seq/c_elegans.PRJNA13758.genomic.fa.gz -n
...
# local
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going --reason output/transcriptome/celegans/ref/wormbase/release{269,270}/seq/transcriptome.fa.gz -n
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going output/genome/celegans/ref/wormbase/release{260,269,270}/annotation/gff3/c_elegans.PRJNA13758.annotations.gff3.gz -n
...
# snakemake --cores 7 --resources downloads=1 --use-conda --printshellcmds --keep-going output/genome/celegans/wormbase/release{260,269}/annotation/c_elegans.PRJNA13758.annotations.gff2.gz
