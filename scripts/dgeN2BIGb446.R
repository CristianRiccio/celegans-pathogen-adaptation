# DGE N2 on HB101 and BIGb446 embryos
...
countdata4 <- countdata3[, 10:15]

condition <- rep(c('embryos_hb101', 'embryos_BIGb446'), each = 3)
...
dge <- DESeq2::results(dds2, c('condition', 'embryos_hb101', 'embryos_BIGb446')) %>% data.frame()
...
write.csv(significantGenes, paste0('output/HS678/DGE/embryosHB101BIGb446.csv'))
# Save the DGE analysis in an R object
save(dge, file = 'output/HS678/robjects/embryosHB101BIGb446.rda')
