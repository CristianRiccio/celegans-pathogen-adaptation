...
countdata4 <- countdata3[, c(1, 2, 3, 10, 11, 12)]

condition <- rep(c('n2', 'nob27'), each = 3)
...
dge <- DESeq2::results(dds2, c('condition', 'n2', 'nob27')) %>% data.frame()
...
write.csv(significantGenes, paste0('output/HS755/DGE/n2nob27.csv'))
# Save the DGE analysis in an R object
save(dge, file = 'output/HS755/robjects/n2nob27.rda')
